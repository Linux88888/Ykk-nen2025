# Ykkönen 2025 – Lopulliset tulokset
...
| Suoritus | Pisteet |
|----------|--------:|
| Syöttö – veikattava pelaaja pelasi/teki maalin, ei top 5 | 1p |
| Maali – veikattava pelaaja top 5 maalintekijöissä | 2p |
...
## Ville Viikinki (VV) – Veikkaus ja pisteytys

### Sarjataulukko

| Sija | VV:n veikkaus | Toteutunut | Pisteet |
|-----:|---------------|------------|--------:|
...
| Kategoria | VV:n veikkaus | Toteutunut | Pisteet |
|-----------|---------------|------------|--------:|
| Nousija | FC Lahti | FC Lahti | 5p ✓ |
| Karsija | Jippo | PK-35 | 0p ✗ |

**Nousija/Karsija yhteensä: 5p**
...
| Muzinga Jonathan | ✗ | Ei top 5, teki maaleja kaudella | 1p |
| Augusto Ferreira Martim | ✗ | Ei top 5, teki syöttöjä kaudella | 1p |
...
| Nousija | 5p |
| Karsija | 0p |
| Maalintekijät (3 maalia × 2p + 2 syöttöä × 1p) | 8p |
| **Yhteensä** | **22p** |

### Ville Viikinki (VV) – **Lopulliset pisteet: 22p**
